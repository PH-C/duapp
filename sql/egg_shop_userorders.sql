...
CREATE TABLE `userorders` (
  ...
  `usersell_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `usersell_id` (`usersell_id`),
  CONSTRAINT `userorders_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `userorders_ibfk_2` FOREIGN KEY (`usersell_id`) REFERENCES `usersells` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
